...
```
$ python3 detect.py --image_folder path/to/img --weights_path ./weights/yolov3_300420.pth --model_def config/yolov3-custom.cfg --class_path data/ecp/ecp.names --img_size 416
```

That's it for instructions on running on GPU workstation in your lab. The followings are general descriptions.
